...
import { removeProduct } from "../../reducers/gardeMangerReducer";
import colors from "../../theme"
import { StyledGardeManger, HiddenItemView } from "./styled";

const SwipeList = () => {
  const navigation = useNavigation();
  const data = useSelector((state) => state.gardeMangerReducer.products)
  ...
  return (
    <Box bg="white" width="100%" safeArea flex="1">
      ...
      />
      : <Center><Text>Your Garde Manger is empty, please add products.</Text></Center>
      }
    </Box>
  );
}
